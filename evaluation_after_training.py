...
def evaluate_after_training(agent_files,file_name_or,p_target,p_0,type=None,translation=None,theta=None):
    ...
    for agent_name in agent_files:
        ...
        rewards_per_episode, rewards_t_per_episode, rewards_d_per_episode,success_rate,_=evaluate_agent(agent,env,config_eval['eval_episodes'],config_eval,'','',False,title='',plot=False,parameters=parameters,plot_background=False)
...
if __name__=='__main__':
    ...
    agents_file = [agent_file_1,agent_file_2,agent_file_3,agent_file_4,agent_file_5,agent_file_6,agent_file_7,agent_file_8,agent_file_9]
    

    results = evaluate_after_training(agents_file,'result_evaluation_u_bg_uniform.json',type='ondulating',p_target = np.array([2,2]),p_0 = np.array([0,0]))
